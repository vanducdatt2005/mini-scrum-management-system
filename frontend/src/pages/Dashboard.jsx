  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4 }}>
      <Box sx={{ mb: 4, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <Button variant="outlined" color="error" onClick={() => { localStorage.clear(); navigate('/register'); }}>
          Đăng xuất
        </Button>
      </Box>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={8}>
          <Paper sx={{ p: 3, borderRadius: 2 }}>
            <Typography variant="h6" gutterBottom>Danh sách User Stories</Typography>
            <Divider sx={{ mb: 2 }} />
        ...
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 3, borderRadius: 2, bgcolor: '#f5f5f5' }}>
            <Typography variant="h6" gutterBottom>Quản lý nhóm</Typography>
            <Divider sx={{ mb: 2 }} />
